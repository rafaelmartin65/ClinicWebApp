							...
							<tr>
								<c:forEach items="${pacientes}" var="paciente">
									<tr>
										...
										<td>
											<%-- <a href='<c:url value="/paciente/${paciente.idPaciente}/actualizar" />'>Modificar</a> --%>
											<%-- <a href='<c:url value="/paciente/${paciente.idPaciente}/eliminar" />'>Eliminar</a> --%>
											<a href="./paciente/${paciente.idPaciente}/actualizar"
